...
{
    public class TMU : GameBuilder<CGameCtnMediaTrackBuilder, CGameCtnMediaTrack>
    {
        public TMU(CGameCtnMediaTrackBuilder baseBuilder, CGameCtnMediaTrack node) : base(baseBuilder, node) { }
