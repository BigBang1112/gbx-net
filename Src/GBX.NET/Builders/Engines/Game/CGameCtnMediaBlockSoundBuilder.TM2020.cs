...
{
    public class TM2020 : GameBuilder<CGameCtnMediaBlockSoundBuilder, CGameCtnMediaBlockSound>
    {
        ...
        public TM2020(CGameCtnMediaBlockSoundBuilder baseBuilder, CGameCtnMediaBlockSound node) : base(baseBuilder, node) { }
