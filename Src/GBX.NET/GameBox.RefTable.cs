...
public partial class GameBox
{
	public class RefTable
    {
        ...
        public RefTable(int ancestorLevel, IList<Folder> folders, IList<File> files)
        {
        ...
        public static RefTable? Parse(Header header, GameBoxReader r, ILogger? logger = null)
        {
            ...
            return new RefTable(ancestorLevel, folders, files);
        }

        public void Write(Header header, GameBoxWriter w)
        {
        ...
        public Node? GetNode(Node? nodeAtTheMoment, int? nodeIndex, string? fileName)
        {
            ...
            return ParseNode(finalFileName);
        }
