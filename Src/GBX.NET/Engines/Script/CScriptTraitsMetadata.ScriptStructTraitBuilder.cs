...
public partial class CScriptTraitsMetadata
{
    public class ScriptStructTraitBuilder
    {
        ...
        public ScriptStructTraitBuilder(ScriptStructTypeBuilder typeBuilder)
        {
            ...
            Members = new(typeBuilder.Members);
        }
        ...
        public ScriptStructTraitBuilder WithBoolean(string name, bool value)
        {
            ...
            Members[name] = new ScriptTrait<bool>(new ScriptType(EScriptType.Boolean), value);
            return this;
        }
        ...
        public ScriptStructTraitBuilder WithInteger(string name, int value)
        {
            ...
            Members[name] = new ScriptTrait<int>(new ScriptType(EScriptType.Integer), value);
            return this;
        }
        ...
        public ScriptStructTraitBuilder WithReal(string name, float value)
        {
            ...
            Members[name] = new ScriptTrait<float>(new ScriptType(EScriptType.Real), value);
            return this;
        }
        ...
        public ScriptStructTraitBuilder WithText(string name, string value)
        {
            ...
            Members[name] = new ScriptTrait<string>(new ScriptType(EScriptType.Text), value);
            return this;
        }
        ...
        public ScriptStructTraitBuilder WithVec2(string name, Vec2 value)
        {
            ...
            Members[name] = new ScriptTrait<Vec2>(new ScriptType(EScriptType.Vec2), value);
            return this;
        }
        ...
        public ScriptStructTraitBuilder WithVec3(string name, Vec3 value)
        {
            ...
            Members[name] = new ScriptTrait<Vec3>(new ScriptType(EScriptType.Vec3), value);
            return this;
        }
        ...
        public ScriptStructTraitBuilder WithInt3(string name, Int3 value)
        {
            ...
            Members[name] = new ScriptTrait<Int3>(new ScriptType(EScriptType.Int3), value);
            return this;
        }
        ...
        public ScriptStructTraitBuilder WithInt2(string name, Int2 value)
        {
            ...
            Members[name] = new ScriptTrait<Int2>(new ScriptType(EScriptType.Int2), value);
            return this;
        }
