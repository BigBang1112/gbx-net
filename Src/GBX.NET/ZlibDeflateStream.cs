...
internal class ZlibDeflateStream : Stream, IXorTrickStream
{
    #region zlib interop
    ...
    {
        if (_innerStream is IXorTrickStream crytedStream)
        {
            crytedStream.InitializeXorTrick(bytes, offset, count);
        }
    }
}
