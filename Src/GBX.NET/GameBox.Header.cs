...
public partial class GameBox
{
    public class Header
    {
        ...
        /// <returns>An immutable <see cref="Header"/> object.</returns>
        ...
        public static Header Parse(GameBoxReader r, ILogger? logger = null)
        {
            if (!r.HasMagic(Magic))
            {
        ...
        /// <exception cref="ObjectDisposedException">The stream is closed.</exception>
        /// <exception cref="IOException">An I/O error occurs.</exception>
        public static Header Parse(Stream stream, ILogger? logger = null)
        {
        ...
        /// <exception cref="TextFormatNotSupportedException">Text-formatted Gbx is not supported.</exception>
        /// <exception cref="IOException">An I/O error occurs.</exception>
        public static Header Parse(string fileName, ILogger? logger = null)
        {
