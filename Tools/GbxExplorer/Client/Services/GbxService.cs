...
using GbxExplorer.Client.Exceptions;
...
public class GbxService : IGbxService
{
                                                    ...
                                                    CancellationToken cancellationToken = default)
    {
        ...
        var gbxParseAsyncAction = new GameBoxAsyncReadAction
        {
            AfterChunkIteration = async (node, chunk) => await asyncEvent("AfterChunkIteration"),
            OnReadNode = async (node, chunk) => await asyncEvent("OnReadNode")
        };
        ...
        try
        {
            ...
            {
                gbx = await GameBox.ParseAsync(gbxStream,
                    logger: _logger,
                    readUncompressedBodyDirectly: true,
                    asyncAction: gbxParseAsyncAction,
